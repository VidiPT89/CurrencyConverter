(() => {
  ...
  const CURRENCY_TO_FLAG = {
    ...
    MAD: '🇲🇦', DZD: '🇩🇿', KES: '🇰🇪', GHS: '🇬🇭',
    AFN: '🇦🇫', ALL: '🇦🇱', AMD: '🇦🇲', ANG: '🇨🇼', AOA: '🇦🇴', AWG: '🇦🇼',
    AZN: '🇦🇿', BAM: '🇧🇦', BBD: '🇧🇧', BHD: '🇧🇭', BIF: '🇧🇮', BMD: '🇧🇲',
    BND: '🇧🇳', BOB: '🇧🇴', BSD: '🇧🇸', BTN: '🇧🇹', BWP: '🇧🇼', BYN: '🇧🇾',
    BZD: '🇧🇿', CDF: '🇨🇩', CLF: '🇨🇱', CNH: '🇨🇳', CRC: '🇨🇷', CUP: '🇨🇺',
    CVE: '🇨🇻', DJF: '🇩🇯', DOP: '🇩🇴', ERN: '🇪🇷', ETB: '🇪🇹', FJD: '🇫🇯',
    FKP: '🇫🇰', FOK: '🇫🇴', GEL: '🇬🇪', GGP: '🇬🇬', GIP: '🇬🇮', GMD: '🇬🇲',
    GNF: '🇬🇳', GTQ: '🇬🇹', GYD: '🇬🇾', HNL: '🇭🇳', HTG: '🇭🇹', IMP: '🇮🇲',
    IQD: '🇮🇶', IRR: '🇮🇷', JEP: '🇯🇪', JMD: '🇯🇲', JOD: '🇯🇴', KGS: '🇰🇬',
    KHR: '🇰🇭', KID: '🇰🇮', KMF: '🇰🇲', KYD: '🇰🇾', KZT: '🇰🇿', LAK: '🇱🇦',
    LBP: '🇱🇧', LKR: '🇱🇰', LRD: '🇱🇷', LSL: '🇱🇸', LYD: '🇱🇾', MDL: '🇲🇩',
    MGA: '🇲🇬', MKD: '🇲🇰', MMK: '🇲🇲', MNT: '🇲🇳', MOP: '🇲🇴', MRU: '🇲🇷',
    MUR: '🇲🇺', MVR: '🇲🇻', MWK: '🇲🇼', MZN: '🇲🇿', NAD: '🇳🇦', NIO: '🇳🇮',
    NPR: '🇳🇵', OMR: '🇴🇲', PAB: '🇵🇦', PGK: '🇵🇬', PYG: '🇵🇾', RSD: '🇷🇸',
    RWF: '🇷🇼', SBD: '🇸🇧', SCR: '🇸🇨', SDG: '🇸🇩', SHP: '🇸🇭', SLE: '🇸🇱',
    SLL: '🇸🇱', SOS: '🇸🇴', SRD: '🇸🇷', SSP: '🇸🇸', STN: '🇸🇹', SYP: '🇸🇾',
    SZL: '🇸🇿', TJS: '🇹🇯', TMT: '🇹🇲', TND: '🇹🇳', TOP: '🇹🇴', TTD: '🇹🇹',
    TVD: '🇹🇻', TZS: '🇹🇿', UGX: '🇺🇬', UYU: '🇺🇾', UZS: '🇺🇿', VES: '🇻🇪',
    VUV: '🇻🇺', WST: '🇼🇸', XAF: '🌍', XCD: '🏝️', XCG: '🇨🇼', XDR: '🌐',
    XOF: '🌍', XPF: '🇵🇫', YER: '🇾🇪', ZMW: '🇿🇲', ZWG: '🇿🇼', ZWL: '🇿🇼',
  };
